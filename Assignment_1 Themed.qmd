...
<span class="gradient-text">ROAS is the highest among demand harvesting efforts at 2260%. We can hire a second SEO specialist with 10000 USD who will focus solely on Demand Harvesting and produce and optimize more content, increase rankings and the number of keywords we are focusing on. </span> 
:::

### Keyword Analysis

::: my-custom-div
To identify SEO opportunities, we use Search Console. Currently, Rogue Fitness shows up on the <span class="highlight">second page</span> of the SERP for 14 keywords.
:::
...
::: aside
The following model was used to filter results in the table: $10 < \xi < 20$ where $\xi \text{ is Position}$.
:::
